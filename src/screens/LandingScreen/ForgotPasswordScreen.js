...
import { View, Text, StyleSheet, ScrollView, Image, KeyboardAvoidingView, TouchableOpacity, Dimensions } from 'react-native';
            ...
            <View style={styles.root}>
                <View style={styles.container}>
                    ...
                    <View style={styles.footer}>
                        <Text style={{
                            color: "#7C7C7A", marginLeft: 25, marginTop: 35, fontSize: 14, fontFamily: 'WorkSans-Regular',
                        }}>Remembered your Password? </Text>
                        <TouchableOpacity onPress={loggedin}>
                            <Text style={{
                                color: "#004277", fontSize: 14, marginTop: 35, marginLeft: 5, fontFamily: 'WorkSans-Regular',
                            }}>Login</Text>
